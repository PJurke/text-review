...
const getGoogleProfileImageUrl = (url: string, size: number = 200): string => {
...
export default async function Page(): Promise<JSX.Element> {
    ...
    return (
        ...
        <main className="max-w-[50ch] md:max-w-[75ch] mx-auto p-4">
            ...
            { user.image &&
                <Image alt="My Profile Picture" className="border-8 border-gray-200 mt-10 mx-auto rounded-xl" height={200} src={getGoogleProfileImageUrl(user.image)} width={200} />
            }
